...
{
    ACRION_IMAGE_TOOLS_EXPORT std::string GetVersion();
    ACRION_IMAGE_TOOLS_EXPORT std::string GetImageMagickVersion();
    ACRION_IMAGE_TOOLS_EXPORT std::string GetCfitsioVersion();
}
